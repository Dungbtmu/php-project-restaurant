                ...
                <div class="foot-columns">
                    <div class="cols-1 col">
                        ...
                        <div class="footer-form">
                            <form action="" method="post" name="nwsLetterForm" id="nwsLetterForm"
                                ...
                                <div class="mb-3"> <input type="text" class="form-control" name="first_name"
                                        id="first_name" placeholder="First Name*"> </div>
                                <div class="mb-3"> <input type="text" class="form-control" name="last_name"
                                        id="last_name" placeholder="Surname*">
                                </div>
                                <div class="mb-3"> <input type="email" class="form-control" name="email_id"
                                        id="email_id" placeholder="Email Address*">
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="cols-4 col">
                        <section id="block-8" class="widget widget_block">
                            ...
                            <br>
                            <p>
                                <a href="https://www.instagram.com/toiladatpham/" target="_blank">
                                    <i class="fa-brands fa-instagram" style="font-size:30px;margin-right:10px;"></i>
                                </a>
                                <a href="https://www.facebook.com/sexyfishlondon" target="_blank">
                                    <i class="fa-brands fa-facebook" style="font-size:30px;margin-right:10px;"></i></a>
                            </p>
                        </section>
                    </div>
                </div>
